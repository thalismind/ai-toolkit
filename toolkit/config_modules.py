...
class DatasetConfig:
    ...
    def __init__(self, **kwargs):
        ...
        # validation split - fraction of dataset to use for validation (0.0 to 1.0)
        self.validation_split: float = kwargs.get('validation_split', 0.0)
        self.validation_seed: int = kwargs.get('validation_seed', 42)
